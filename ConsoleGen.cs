...
public class ConsoleGen
{
	public static ConsoleSystem.Command[] All = new ConsoleSystem.Command[1371]
	{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.AntiHack.projectile_update_limit.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.AntiHack.rpcstallmode.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Clan.scoreForDestroyingBradley.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Clan.scoreForDestroyingToolCupboards.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Clan.scoreForHackingCrates.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Clan.scoreForKilledByPlayerInOtherClan.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Clan.scoreForKillingPlayerInOtherClan.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Clan.scoreForKillingUnarmedPlayer.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Clan.scoreForLootingEliteCrate.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Clan.scoreForOpeningHackedCrates.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Clan.scoreForReachingCargoShip.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Clan.scoreForRunningExcavator.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			Name = "deletepaste",
			Parent = "copypaste",
			FullName = "copypaste.deletepaste",
			ServerAdmin = true,
			Description = "<name>",
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
				CopyPaste.deletepaste(arg);
			}
		},
		new ConsoleSystem.Command
		{
			Name = "downloadpaste",
			Parent = "copypaste",
			FullName = "copypaste.downloadpaste",
			ServerAdmin = true,
			Description = "<url> <name>",
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
				CopyPaste.downloadpaste(arg);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			Name = "loadpaste",
			Parent = "copypaste",
			FullName = "copypaste.loadpaste",
			ServerAdmin = true,
			Description = "<name>",
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
				CopyPaste.load_sv(arg);
			}
		},
		new ConsoleSystem.Command
		{
			Name = "paste_sv",
			Parent = "copypaste",
			FullName = "copypaste.paste_sv",
			ServerAdmin = true,
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
				CopyPaste.paste_sv(arg);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			Name = "renamepaste",
			Parent = "copypaste",
			FullName = "copypaste.renamepaste",
			ServerAdmin = true,
			Description = "<old> <new>",
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
				CopyPaste.renamepaste(arg);
			}
		},
		new ConsoleSystem.Command
		{
			Name = "savepaste",
			Parent = "copypaste",
			FullName = "copypaste.savepaste",
			ServerAdmin = true,
			Description = "<name>",
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
				CopyPaste.save_sv(arg);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Description = "Make admin invisibile",
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
				Debugging.invis(arg);
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => Debugging.tutorial_start_cooldown.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			Name = "benchmark_demo_upload",
			Parent = "demo",
			FullName = "demo.benchmark_demo_upload",
			ServerAdmin = true,
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Demo.DemoDiskCleanupIntervalMinutes.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Demo.DemoUploadConcurrency.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Demo.MaxDemoDiskSpaceGB.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Saved = true,
			Variable = true,
			GetOveride = () => Demo.ServerDemoFlushInterval.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => ConVar.Physics.serverragdollmode.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Ping.ping_refresh_interval.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Ping.ping_samples.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Description = "profile.perfsnapshot [delay=15, int] [name='Profile', str, no extension, max 32chars] [frames=10, int, max 10].\nWill produce a JSON perf snapshot that can be viewed in Perfetto or similar tools",
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg)
			{
				ConVar.Profile.PerfSnapshot(arg);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => reports.ExceptionReportMaxLength.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval18 = ConVar.Server.combatlog(arg);
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval17 = ConVar.Server.combatlog_outgoing(arg);
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Server.http_connection_limit.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Server.itemdespawn_container_max_multiplier.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval16 = ConVar.Server.netprotocol(arg);
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval15 = ConVar.Server.packetlog(arg);
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval14 = ConVar.Server.printdecryptqueue(arg);
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval13 = ConVar.Server.printeyes(arg);
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval12 = ConVar.Server.printpos(arg);
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval11 = ConVar.Server.printposcenter(arg);
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval10 = ConVar.Server.printreadqueue(arg);
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval9 = ConVar.Server.printrot(arg);
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval8 = ConVar.Server.printwritequeue(arg);
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval7 = ConVar.Server.readcfg(arg);
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Server.rejoin_delay.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval6 = ConVar.Server.rpclog(arg);
		...
		new ConsoleSystem.Command
		{
			Name = "workbench1taxrate",
			Parent = "server",
			FullName = "server.workbench1taxrate",
			ServerAdmin = true,
			ClientAdmin = true,
			Client = true,
			Saved = true,
			Description = "How much of a tax to apply to workbench T1 tech unlocks. 10 = additional 10% scrap cost",
			Replicated = true,
			Variable = true,
			GetOveride = () => ConVar.Server.workbench1TaxRate.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Server.workbench1TaxRate = str.ToFloat();
			},
			Default = "0"
		},
		new ConsoleSystem.Command
		{
			Name = "workbench2taxrate",
			Parent = "server",
			FullName = "server.workbench2taxrate",
			ServerAdmin = true,
			ClientAdmin = true,
			Client = true,
			Saved = true,
			Description = "How much of a tax to apply to workbench T2 tech unlocks. 10 = additional 10% scrap cost",
			Replicated = true,
			Variable = true,
			GetOveride = () => ConVar.Server.workbench2TaxRate.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Server.workbench2TaxRate = str.ToFloat();
			},
			Default = "10"
		},
		new ConsoleSystem.Command
		{
			Name = "workbench3taxrate",
			Parent = "server",
			FullName = "server.workbench3taxrate",
			ServerAdmin = true,
			ClientAdmin = true,
			Client = true,
			Saved = true,
			Description = "How much of a tax to apply to workbench  T3tech unlocks. 10 = additional 10% scrap cost",
			Replicated = true,
			Variable = true,
			GetOveride = () => ConVar.Server.workbench3TaxRate.ToString(),
			SetOveride = delegate(string str)
			{
				ConVar.Server.workbench3TaxRate = str.ToFloat();
			},
			Default = "20"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			Replicated = true,
			Variable = true,
			GetOveride = () => ConVar.Time.cl_maxstepsperframe.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Replicated = true,
			Variable = true,
			GetOveride = () => ConVar.Time.cl_steps.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => ConVar.Time.sv_maxstepsperframe.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => ConVar.Time.sv_steps.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval5 = SteamNetworking.steamstatus();
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => Facepunch.Rcon.Listener.MaxPasswordFailures.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => RuntimeProfiler.command_lagspike_threshold.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => RuntimeProfiler.profiling_entities.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => RuntimeProfiler.profiling_entity_count_interval.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => RuntimeProfiler.profiling_fixed_invokes.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Description = "0 = off, 1 = stats per frame, 2 = stats per method",
			Variable = true,
			GetOveride = () => RuntimeProfiler.profiling_invokes.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => RuntimeProfiler.profiling_ping.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => RuntimeProfiler.profiling_ping_per_frame.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => RuntimeProfiler.profiling_rcon.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => RuntimeProfiler.profiling_rcon_message_length.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => RuntimeProfiler.rcon_lagspike_threshold.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => RuntimeProfiler.rpc_lagspike_threshold.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => RuntimeProfiler.runtime_profiling.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => RuntimeProfiler.runtime_profiling_interval.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => RuntimeProfiler.runtime_profiling_pool_flush_interval.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => RuntimeProfiler.runtime_profiling_pooling.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => TickLogging.tick_uploader_lifetime.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			Name = "displaydistancemultiplier",
			Parent = "espcanvas",
			FullName = "espcanvas.displaydistancemultiplier",
			ServerAdmin = true,
			ClientAdmin = true,
			Client = true,
			Description = "Multiply the maximum distance for displaying players nameplates",
			Replicated = true,
			Variable = true,
			GetOveride = () => ESPCanvas.DisplayDistanceMultiplier.ToString(),
			SetOveride = delegate(string str)
			{
				ESPCanvas.DisplayDistanceMultiplier = str.ToFloat();
			},
			Default = "1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			Replicated = true,
			Variable = true,
			GetOveride = () => LegacyShelter.max_shelters.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => MetalDetectorSource.AttemptsPerSubSourceSpawn.ToString(),
			SetOveride = delegate(string str)
			{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval4 = RelationshipManager.createAndAddToTeam(arg);
		...
		new ConsoleSystem.Command
		{
			Name = "framebudgetms",
			Parent = "fsmcomponent",
			FullName = "fsmcomponent.framebudgetms",
			ServerAdmin = true,
			Description = "How many milliseconds to spend on the AIs FSMs per frame",
			Variable = true,
			GetOveride = () => FSMComponent.frameBudgetMs.ToString(),
			SetOveride = delegate(string str)
			{
				FSMComponent.frameBudgetMs = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			Parent = "fsmcomponent",
			FullName = "fsmcomponent.maxrefreshintervalseconds",
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => FSMComponent.maxRefreshIntervalSeconds.ToString(),
			SetOveride = delegate(string str)
			{
				FSMComponent.maxRefreshIntervalSeconds = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
			...
			Parent = "fsmcomponent",
			FullName = "fsmcomponent.minrefreshintervalseconds",
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => FSMComponent.minRefreshIntervalSeconds.ToString(),
			SetOveride = delegate(string str)
			{
				FSMComponent.minRefreshIntervalSeconds = str.ToFloat();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			Name = "monument_scenes_enabled",
			Parent = "scenetoprefab",
			FullName = "scenetoprefab.monument_scenes_enabled",
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => SceneToPrefab.monument_scenes_enabled.ToString(),
			SetOveride = delegate(string str)
			{
				SceneToPrefab.monument_scenes_enabled = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval3 = ServerOcclusion.serverocclusiondebug(arg);
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval2 = TravellingVendor.svspawntravellingvendor(arg);
		...
		new ConsoleSystem.Command
		{
			...
			Variable = true,
			GetOveride = () => TreeManager.CellSize.ToString(),
			SetOveride = delegate(string str)
			{

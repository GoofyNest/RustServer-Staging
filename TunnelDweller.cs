...
public class TunnelDweller : HumanNPC
{
	...
	protected override void OnKilledByPlayer(BasePlayer p)
	{
		...
		if (GameInfo.HasAchievements && p.GetParentEntity() != null && p.GetParentEntity() is TrainEngine trainEngine && trainEngine.CurThrottleSetting != TrainEngine.EngineSpeeds.Zero && trainEngine.IsMovingOrOn)
		{

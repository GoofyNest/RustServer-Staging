...
public class FireBall : BaseEntity, ISplashable
{
	...
	public void Think()
	{
		if (base.isServer)
		{
			UpdateIsStationary(Vector3.Distance(lastPos, base.transform.localPosition) < 0.25f);
	...
	{
		if (shouldBeStationary != IsStationary && shouldBeStationary && TimeAlive() > 1f && CanMerge())
		{

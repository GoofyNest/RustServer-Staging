...
public class Wolf2FSM : FSMComponent
{
	...
	public override void InitShared()
	{
		if (base.baseEntity.isServer)
		{
			...
			{
				Inverted = true
			}).AddTickTransition(treeNode32, EncounterEndTrans).AddChildren(treeNode7.AddTickTransition(treeNode32, new Trans_TargetOrSelfInWater()).AddTickTransition(treeNode18, PathFailedTrans).AddChildren(treeNode6.AddTickTransition(treeNode22, new Trans_TargetIsNearFire
			{
